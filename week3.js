...
for (let key in myPet) {
    if (myPet.hasOwnProperty(key)) {
        let value = myPet[key];
        console.log("Q3: " + key + " : " + value);
    }
}
...
function Dog(name, breed, age, extraprop) {
    this.name = name;
    this.breed = breed;
    this.age = age;
...
let dog4 = new Dog("Kroger", "greyhound", 8, "blah");
...
const areObjectsEqual = (obj1, obj2) => {
    ...
    return values1.every(([key, value]) =>
