...
const floatingPoint = 1.2;
const integer = 8;
const negative = -7;
const notANumber = 4 * "bloooop";
...
let q3true = true;
console.log("Q3: The variable I made true is:", q3true);
//The output of the above should be true.
let q3false = false;
console.log("Q3: The variable I made false is:", q3false);
...
let message = "Hello! My name is " + firstName + lastName + ". I was born in the " + country;
console.log(message);

const messageTL = `Hello! My name is ${firstName} ${lastName}. I was born in ${country}.`;
...
const var1 = floatingPoint + integer;
console.log(var1);
const var2 = integer + negative;
console.log(var2);
...
function useParams(param14) {
    return (param14.toUpperCase());
}
console.log(useParams("wazzup??"));
...
let word2 = "This is another string"
